  ...
  const app = express();
  // Définition de la route pour le endpoint /tags
  ...
  // Définit un groupe de tests pour la méthode `findAll` du Model tag
  describe('findAll', () => {
    // Teste si la méthode `findAll` renvoie tous les tags existants de la base de données, si elle est exécutée correctement
    it('devrait retourner tous les tags', async () => {
